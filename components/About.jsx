...
const About = () => {
    ...
    useGSAP(() => {
        const title = new SplitText('#about h2', {type: 'words'})
        const tl = gsap.timeline({scrollTrigger: {trigger: '#about', start: 'top 80%'}})
        tl.from(title.words, { yPercent: 100, opacity: 0, duration: 1, stagger: 0.02, ease:'expo.out',})
        tl.from('.top-grid div, .bottom-grid div', { opacity: 0, duration: 1, stagger: 0.04, ease:'power1.inOut'}, '-=0.5')
    })
  return (
    <div id='about'>
